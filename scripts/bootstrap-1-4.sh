...
binariesInstall() {
  ...
  binaryDownload ${BINARY_FILE} https://raw.githubusercontent.com/hyperledger/fabric/master/scripts/bootstrap.sh | bash -s 1.4.3
  if [ $? -eq 22 ]; then
     echo
  ...
  binaryDownload ${CA_BINARY_FILE} https://raw.githubusercontent.com/hyperledger/fabric/master/scripts/bootstrap.sh | bash -s 1.4.3
  if [ $? -eq 22 ]; then
     echo
